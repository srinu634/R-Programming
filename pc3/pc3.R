...
setwd("C:\\Users\\redhawk\\Documents\\GitHub\\R-Programming\\pc3")
...
attributes <<- names(pc3.disc.data) #Global variable
whitelist.arcs <<- NULL
...
len <<- length(pc3.disc.data) #Number of attributes
from <<- NULL
for( i in 1:(len-1)){
  from <- c( from,c("L")) 
}
...
setwd("C:\\Users\\redhawk\\Documents\\GitHub\\R-Programming\\pc3\\plots")
